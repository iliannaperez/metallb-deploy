pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/iliannaperez/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('perezi3-225')   // <---- Change this to match your kubernetes cluster credentials
    }
